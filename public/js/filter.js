...
function getUniqueValuesFromColumn4(){

    var unique_col_values_dict = {};
    allFilters = document.querySelectorAll(".table-filter4");

    allFilters.forEach((filter_i) => {
        col_index = filter_i.parentElement.getAttribute("col-index");
        // alert(col_index);

        const rows = document.querySelectorAll("#detailsTable4 > tbody > tr");
    ...
    updateSelectOptions4(unique_col_values_dict);
};
...
function updateSelectOptions4(unique_col_values_dict){
    allFilters = document.querySelectorAll(".table-filter4");
